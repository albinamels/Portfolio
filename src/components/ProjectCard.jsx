    ...
    <article className="grid lg:grid-cols-2 gap-x-20 gap-10 my-10">
      ...
      <div className=" px-1  text-slate-700">
        ...
        <div className="mt-5 mb-3 flex gap-x-10">
          <a href={url} target="blank">
            <TbWorldWww className="h-8 w-8 text-stone-500 hover:text-emerald-500 duration-300" />
          </a>

          <a href={github} target="blank">
            <FaGithub className="h-8 w-8 text-stone-500 hover:text-emerald-500 duration-300 " />
          </a>
        </div>
      </div>
    </article>
